...
// (!) notes: remove "union" to avoid KLEE errors (it is an efficient data structure, storing different datas in the same memry location) 
...
// typedef struct OblivBit
// {
//   int unknown; // A regular integer field
//   union 
//   {
//     int knownValue; // A union with one member: an integer
//   };
// } OblivBit;
