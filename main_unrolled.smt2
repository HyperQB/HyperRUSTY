...
; Unrolled states
(declare-const |s_B_0| |main_s|)
(declare-const |s_B_1| |main_s|)
(declare-const |s_B_2| |main_s|)
(declare-const |s_B_3| |main_s|)

; Initial and Next-state constraints
(assert (and (|main_i| |s_B_0|) (|main_t| s_B_0 s_B_1) (|main_t| s_B_1 s_B_2) (|main_t| s_B_2 s_B_3) ))
